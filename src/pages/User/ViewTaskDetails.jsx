  ...
  return (
    <div className="flex items-center gap-3 p-3">
      <input
        ...
        checked={isChecked}
        onChange={onChange}
        className="w-4 h-4 text-primary bg-gray-100 rounded-sm border-gray-300 outline-none cursor-pointer"
      />
...
const Attachment = ({ link, index, onClick }) => {
  return (
    <div
      className="flex justify-between bg-gray-50 border border-gray-100 px-3 py-4 rounded-md mb-3 mt-2 cursor-pointer"
      onClick={onClick}
    >
